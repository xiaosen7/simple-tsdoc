 ...
 * @category Array
 */
declare function flattenArrayable<T>(
 ...
 * ```
 */
declare function objectMap<K extends string, V, NK = K, NV = V>(
  obj: Record<K, V>,
 ...
 * @category Object
 */
declare function deepMerge<T extends object = object, S extends object = T>(
  target: T,
  ...sources: S[]
): DeepMerge<T, S>;
/**
 ...
 * @category Object
 */
declare function objectPick<O, T extends keyof O>(
  obj: O,
  keys: T[],
